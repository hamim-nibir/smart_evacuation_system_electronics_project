...
void setup() {
  ...
  // --- I2C slave setup ---
  Wire.begin(UNO_ADDR);        // Join I2C bus as slave
  Wire.onRequest(sendCounts);  // Callback when Mega requests data

  Serial.begin(115200);
  Serial.println("=== UNO Human Counter Started ===");
}
...
// ==========================
void sendCounts() {
  // Send comma-separated data to Mega
