...
void loop() {
  ...
  //here i am developing the algorithm => low = 5, medium=10, high = 15
  // Simple risk logic: tweak thresholds to your needs
    int risk1 = 5;
    if ((flameVal1 < 700) || (gasVal1 < 100)) risk1 = 15;
    else if ((flameVal1 < 900) || (gasVal1 < 120)) risk1 = 10;

    int risk2 = 5;
    if ((flameVal2 < 700) || (gasVal2 < 100)) risk2 = 15;
    else if ((flameVal2 < 900) || (gasVal2 < 120)) risk2 = 10;

    int risk3 = 5;
    if ((flameVal3 < 700) || (gasVal3 < 100)) risk3 = 15;
    else if ((flameVal3 < 900) || (gasVal3 < 120)) risk3 = 10;

    int risk4 = 5;
    if ((flameVal4 < 700) || (gasVal4 < 100)) risk4 = 15;
    else if ((flameVal4 < 900) || (gasVal4 < 120)) risk4 = 10;

    int risk5 = 5;
    if ((flameVal5 < 700) || (gasVal5 < 100)) risk5 = 15;
    else if ((flameVal5 < 900) || (gasVal5 < 120)) risk5 = 10;
  ...
  Serial.print(risk1); Serial.print(",");
  Serial.println(hum1);
  ...
  Serial.print(risk2); Serial.print(",");
  Serial.println(hum2);
  ...
  Serial.print(risk3); Serial.print(",");
  Serial.println(hum3);
  ...
  Serial.print(risk4); Serial.print(",");
  Serial.println(hum4);
  ...
  Serial.print(risk5); Serial.print(",");
  Serial.println(hum5);
